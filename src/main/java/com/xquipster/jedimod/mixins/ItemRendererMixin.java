...
public class ItemRendererMixin {
    ...
    private void renderArmFirstPerson(float p_187456_1_, float p_187456_2_, EnumHandSide p_187456_3_)
    {
        ...
        PlayerRender renderplayer = new PlayerRender(renderManager, JediMod.MOD.slim.contains(abstractclientplayer.getName()), JediMod.hdSkins.contains(abstractclientplayer.getName()), JediMod.hdCapes.contains(abstractclientplayer.getName()));
