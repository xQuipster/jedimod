...
public class PlayerRender extends RenderLivingBase<AbstractClientPlayer> {
    ...
    public PlayerRender(RenderManager renderManager, boolean useSmallArms, boolean hdSkin, boolean hdCape)
    {
        ...
        this.addLayer(new LayerCustomDeadmau5Head(this));
    ...
    {
        return (PlayerModel) super.getMainModel();
    }
    ...
    protected void preRenderCallback(@Nonnull AbstractClientPlayer entitylivingbaseIn, float partialTickTime)
    {
        GlStateManager.scale(0.9375F, 0.9375F, 0.9375F);
    }

    protected void renderEntityName(@Nonnull AbstractClientPlayer entityIn, double x, double y, double z, @Nonnull String name, double distanceSq)
    {
